...
class PrisonPhaseWelcomeAction : Action() {
    override fun execute(): Action {
        Conversation(DevcordJamPlugin.instance)
            ...
            .addMessage("Um unsere Familien zu beschützen, müssen wir zusammen arbeiten.", "Dorfbewohner", 4.seconds)
            .addMessage("Mit genug Vorbereitung und den richtigen Waffen können wir sie besiegen, doch dafür müssen wir an einem Strang ziehen.", "Dorfbewohner", 5.seconds)
            .addMessage("Wenn diese Vorbereitungen getroffen sind, können wir einen Gegenangriff vorbereiten, womit sie nicht rechnen. Das ist unsere einzige Chance", "Dorfbewohner", 7.seconds)
            .addMessage("Ich entschuldige mich noch einmal für meine harschen Methoden, doch dieses Thema ist echt wichtig und es geht um uns alle.", "Dorfbewohner", 6.seconds)
            .addMessage("Ich sah mich gezwungen auf solche Methoden zurückzugreifen um uns alle zu schützen.", "Dorfbewohner", 5.seconds)
            .addMessage("Um die <red>Leviatanen</red> zu besiegen, müssen wir ein paar Ressourcen besorgen. Also los gehts!", "Dorfbewohner", 2.seconds)
            .start()
            .whenComplete { _, _ ->
                complete()
            }
